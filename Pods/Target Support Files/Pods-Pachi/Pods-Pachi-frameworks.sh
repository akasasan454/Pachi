...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SilentScrolly/SilentScrolly.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UIView+MGBadgeView/UIView_MGBadgeView.framework"
